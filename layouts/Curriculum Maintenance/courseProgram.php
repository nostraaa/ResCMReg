...
<section class="flex justify-between items-start mb-12 w-full"> 
 ...
 <section class="table-section p-6 bg-white shadow-md rounded-lg">
    <h2 class="text-lg font-semibold text-gray-900 mb-6 text-center">Degree List Table</h2>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
             
                <tr style="background-color: #012D5E; color: white;">
                    <th scope="col" class="px-6 py-3 text-center">Order no.</th>
                    <th scope="col" class="px-6 py-3 text-center">Course Program code</th>
                    <th scope="col" class="px-6 py-3 text-center">Course Program name</th>
                </tr>
            </thead>
            <tbody>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">1.</th>
                    <td class="px-6 py-4 text-center">MA </td>
                    <td class="px-6 py-4 text-center">masteral</td>
                </tr>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">2.</th>
                    <td class="px-6 py-4 text-center">P-BAC</td>
                    <td class="px-6 py-4 text-center">Post-Baccalaureate</td>
                    
                </tr>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">3.</th>
                    <td class="px-6 py-4 text-center">DTR</td>
                    <td class="px-6 py-4 text-center">Doctoral</td>
                </tr>
            </tbody>
        </table>
    </div>
