...
$current_page = 'Department Without Colleges'; // Set this to the title of the current page
$breadcrumbs = [
    'Dashboard' => '/rescmreg/index.php', 
    'Department Without Colleges' => '/rescmreg/layouts/Curriculum Maintenance/DepartmentWithoutColleges.php' 
];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">Accounting</th>
                    <td class="px-6 py-4 text-center">Accounting Department</td>
                    


                </tr>
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">ASFAO</th>
                    <td class="px-6 py-4 text-center">Admission, Scholarship and Financial Assistance Office</td>
                </tr>
