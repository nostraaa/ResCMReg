...
$current_page = 'Final Report of Grades'; // Set this to the title of the current page
$breadcrumbs = [
    'Dashboard' => '/rescmreg/index.php', 
    'Final Report of Grades' => '/rescmreg/layouts/Grades Management/FinalReportOfGrades.php' 
];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="gradesFor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <option value="Grade 1">1st Sem</option>
                        <option value="Grade 2">2nd Sem</option>
                        </select>
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div>
                    <label for="term" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Term</label>
                <input type="text" id="Term" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div>
            ...
            <div class="mt-4">
                <a href="FinalReport.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Proceed</a>
            </div>
